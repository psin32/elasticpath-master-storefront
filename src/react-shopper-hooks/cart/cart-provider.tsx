...
export const CartItemsContext = createContext<
  | ({
    ...
    useScopedAddCustomItemToCart: () => ReturnType<typeof useAddCustomItemToCart>
    useScopedAddSubscriptionItemToCart: () => ReturnType<typeof useAddSubscriptionItemToCart>
