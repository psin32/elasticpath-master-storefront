  ...
  return (
    <div className="grid h-16 grid-cols-[15%_70%_15%] items-center">
      ...
      <input
        ...
        placeholder="Search"
      />
      <div className={clsx("flex", "flex-end h-16 w-[4.5rem] items-center")}>
        <button
...
const HitComponent = ({
  ...
  return (
    <Link className="cursor-pointer" href={`/products/${slug}`} legacyBehavior>
      <div
        className="grid h-24 cursor-pointer grid-cols-6 grid-rows-3 gap-2"
        onClick={closeModal}
      >
...
export const SearchModalKlevu = (): JSX.Element => {
...
export default SearchModalKlevu;
