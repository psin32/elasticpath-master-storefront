    ...
    <div className="my-4 flex flex-col gap-4">
      <div className="flex flex-row items-center justify-evenly gap-4">
        <input
          ...
          value={range[0]}
          onChange={(e) =>
            handleSliderChange([Number(e.target.value), range[1]], true)
          }
        />
        ...
        <input
          ...
          value={range[1]}
          onChange={(e) =>
            handleSliderChange([range[0], Number(e.target.value)], true)
          }
        />
      </div>
      ...
      <Slider
        ...
        onChangeComplete={(val) =>
          throttledSetPriceRange((val as number[])[0], (val as number[])[1])
        }
      />
    </div>
  );
