    ...
    <nav aria-label="Breadcrumb" className="pb-6">
      <ol role="list" className="mx-auto flex max-w-2xl items-center space-x-2 lg:max-w-7xl">
          ...
          return (
            <li key={node.id}>
              <div className="flex items-center">
                <a href={breadcrumbUrl} className="mr-2 text-sm font-medium text-gray-900">{node.attributes.name}</a>
        ...
        <li className="text-sm">
          <a href="#" aria-current="page" className="font-medium text-gray-500 hover:text-gray-600">{productName}</a>
        </li>
      </ol>
    </nav>
  )
