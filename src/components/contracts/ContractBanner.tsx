...
export default function ContractBanner() {
  ...
  if (isLoading || isRefetching) {
    return (
      <div className="w-full bg-gray-100 text-sm py-1.5 border-b border-gray-200 sticky top-[57px] md:top-[57px] z-10">
  ...
  return (
    <>
      <div className="w-full bg-green-50 text-sm py-1.5 border-b border-green-100 sticky top-0 z-10">
        <div className="container mx-auto px-4 flex items-center justify-between">
          <div className="flex items-center">
